...
const UpdateCoffee = () => {
    ...
    return (
        <div className="bg-[#f4f3f0] p-24">
            <h3 className="text-3xl font-extrabold text-center text-gray-800">Update Coffee {name}</h3>
                ...
                <div className="md:flex mb-8">
                    <div className="form-control md:w-1/2">
                        ...
                        <label className="input-group">
                            <input type="text" name="name" defaultValue={name} placeholder="Your Coffee Name" className="input input-bordered w-full" />
                        </label>
                    </div>
